...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('socialaccount_socialtoken', 'token', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'SocialToken.token_secret'
        db.alter_column('socialaccount_socialtoken', 'token_secret', self.gf('django.db.models.fields.CharField')(max_length=500))
    ...
    models = {
        ...
        'socialaccount.socialtoken': {
            ...
            'token_secret': ('django.db.models.fields.CharField', [], {'max_length': '500', 'blank': 'True'})
        }
    }
