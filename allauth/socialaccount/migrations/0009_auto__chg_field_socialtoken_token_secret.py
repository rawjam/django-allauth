...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'socialaccount_socialtoken', 'token_secret', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

    def backwards(self, orm):

        # Changing field 'SocialToken.token_secret'
        db.alter_column(u'socialaccount_socialtoken', 'token_secret', self.gf('django.db.models.fields.CharField')(default='', max_length=500))
    ...
    models = {
        ...
        u'socialaccount.socialtoken': {
            ...
            'token_secret': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'})
        }
    }
