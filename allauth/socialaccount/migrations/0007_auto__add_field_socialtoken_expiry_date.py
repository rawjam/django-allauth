...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SocialToken.expiry_date'
        db.add_column('socialaccount_socialtoken', 'expiry_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SocialToken.expiry_date'
        db.delete_column('socialaccount_socialtoken', 'expiry_date')
